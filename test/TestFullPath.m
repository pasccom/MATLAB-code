classdef TestFullPath < matlab.unittest.TestCase
    properties(TestParameter)
        dataTest = {                                                                                                          ...
            ...
            {fullfile(''),                 fullfile('filex'),                       fullfile('filex')                      }; ...
            {fullfile(''),                 fullfile('file.x'),                      fullfile('file.x')                     }; ...
            ...
            {fullfile(''),                 fullfile('dir1', 'filex') ,              fullfile('dir1', 'filex')              }; ...
            {fullfile(''),                 fullfile('dir1', 'file.x'),              fullfile('dir1', 'file.x')             }; ...
            {fullfile(''),                 fullfile('dir1', '.'),                   fullfile('dir1')                       }; ...
            ...
            {fullfile(''),                 fullfile('dir1', 'subdir11', 'filex'),   fullfile('dir1', 'subdir11', 'filex')  }; ...
            {fullfile(''),                 fullfile('dir1', 'subdir11', 'file.x'),  fullfile('dir1', 'subdir11', 'file.x') }; ...
            {fullfile(''),                 fullfile('dir1', 'subdir11'),            fullfile('dir1', 'subdir11')           }; ...
            {fullfile(''),                 fullfile('dir2', 'file2'),               fullfile('dir2', 'file2')              }; ...
            {fullfile(''),                 fullfile('dir2', 'file.2'),              fullfile('dir2', 'file.2')             }; ...
            {fullfile(''),                 fullfile('dir1', 'subdir12', 'file2'),   fullfile('dir1', 'subdir12', 'file2')  }; ...
            {fullfile(''),                 fullfile('dir1', 'subdir12', 'file.2'),  fullfile('dir1', 'subdir12', 'file.2') }; ...
            {fullfile(''),                 fullfile('dir2', 'subdir21', 'file1'),   fullfile('dir2', 'subdir21', 'file1')  }; ...
            {fullfile(''),                 fullfile('dir2', 'subdir21', 'file.1'),  fullfile('dir2', 'subdir21', 'file.1') }; ...
            {fullfile('dir1'),             fullfile('file1'),                       fullfile('dir1', 'file1')              }; ...
            {fullfile('dir1'),             fullfile('file.1'),                      fullfile('dir1', 'file.1')             }; ...
            {fullfile('dir1'),             fullfile('filex'),                       fullfile('dir1', 'filex')              }; ...
            {fullfile('dir1'),             fullfile('file.x'),                      fullfile('dir1', 'file.x')             }; ...
            ...
            {fullfile('dir1'),             fullfile('..', 'filex'),                 fullfile('filex')                      }; ...
            {fullfile('dir1'),             fullfile('..', 'file.x'),                fullfile('file.x')                     }; ...
            ...
            {fullfile('dir1'),             fullfile('subdir11', 'filex'),           fullfile('dir1', 'subdir11', 'filex')  }; ...
            {fullfile('dir1'),             fullfile('subdir11', 'file.x'),          fullfile('dir1', 'subdir11', 'file.x') }; ...
            {fullfile('dir1'),             fullfile('subdir11', '.'),               fullfile('dir1', 'subdir11')           }; ...
            {fullfile('dir1'),             fullfile('subdir12', 'file2'),           fullfile('dir1', 'subdir12', 'file2')  }; ...
            {fullfile('dir1'),             fullfile('subdir12', 'file.2'),          fullfile('dir1', 'subdir12', 'file.2') }; ...
            {fullfile('dir1'),             fullfile('..', 'dir2', 'file2'),         fullfile('dir2', 'file2')              }; ...
            {fullfile('dir1'),             fullfile('..', 'dir2', 'file.2'),        fullfile('dir2', 'file.2')             }; ...
            ...
            {fullfile('dir1', 'subdir11'), fullfile('filex'),                       fullfile('dir1', 'subdir11', 'filex')  }; ...
            {fullfile('dir1', 'subdir11'), fullfile('file.x'),                      fullfile('dir1', 'subdir11', 'file.x') }; ...
            ...
            {fullfile('dir1', 'subdir11'), fullfile('..', 'filex'),                 fullfile('dir1', 'filex')              }; ...
            {fullfile('dir1', 'subdir11'), fullfile('..', 'file.x'),                fullfile('dir1', 'file.x')             }; ...
            ...
            {fullfile('dir1', 'subdir11'), fullfile('..', '..', 'filex'),           fullfile('filex')                      }; ...
            {fullfile('dir1', 'subdir11'), fullfile('..', '..', 'file.x'),          fullfile('file.x')                     }; ...
            {fullfile('dir1', 'subdir11'), fullfile('..', '..'),                    fullfile('')                           }; ...
            {fullfile('dir1', 'subdir11'), fullfile('..', 'subdir12', 'file2'),     fullfile('dir1', 'subdir12', 'file2')  }; ...
            {fullfile('dir1', 'subdir11'), fullfile('..', 'subdir12', 'file.2'),    fullfile('dir1', 'subdir12', 'file.2') }; ...
            {fullfile('dir1', 'subdir11'), fullfile('..', '..', 'dir2', 'file2'),   fullfile('dir2', 'file2')              }; ...
            {fullfile('dir1', 'subdir11'), fullfile('..', '..', 'dir2', 'file.2'),  fullfile('dir2', 'file.2')             }; ...
        };
        dataUnix = {
            '/xxx'; ...
            '/xxx/yyy'; ...
    ...
    methods(Test)
        function testRelative(self, dataTest)
        ...
        function testAbsolute(self, dataTest)
            basePath = fullfile(self.mTestRoot, dataTest{1});
            self.assumeEqual(exist(basePath, 'dir'), 7);

            cd(basePath);
            absPath = fullfile(self.mTestRoot, dataTest{3});
            self.verifyEqual(fullpath(absPath), absPath);
        end
        function testAbsoluteUnix(self, dataUnix)
            self.verifyEqual(fullpath(dataUnix), strrep(dataUnix, '/', filesep));
        end
    end
